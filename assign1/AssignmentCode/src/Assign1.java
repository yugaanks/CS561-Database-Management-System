 ...
 *  			9. If a customer didn't purchased any product from a state for like in Connecticut or 'CT' then the values such as max will return 0 along with 0 date in report 2
 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int s3 = 0; s3 < all.length; s3++) {
				if (custpro[s3][0] != null) {																			//since i used an integer array which is primitive type, 
					if(all[s3][0]==0 && all[s3][1]!=0 && all[s3][2]!=0)													//so I couldn't add null values to it, So I had to use if else conditions	
					{
						System.out.printf("%-7s %-7s %7s %7s %7s %7s %7d %7d %7d %7d %7d %7d %7d %7d %n", 
								custpro[s3][0],	custpro[s3][1], "null", "null", "null", "null", 
								all[s3][1], month[s3][1], day[s3][1], year[s3][1], 
								all[s3][2], month[s3][2], day[s3][2], year[s3][2]);
					}
					else if(all[s3][0]!=0 && all[s3][1]==0 && all[s3][2]!=0) 
						{
							System.out.printf("%-7s %-7s %7d %7d %7d %7d %7s %7s %7s %7s %7d %7d %7d %7d %n", 
									custpro[s3][0],	custpro[s3][1], all[s3][0], month[s3][0], day[s3][0], year[s3][0], 
									"null", "null", "null", "null", 
									all[s3][2], month[s3][2], day[s3][2], year[s3][2]);
					}else if(all[s3][0]!=0 && all[s3][1]!=0 && all[s3][2]==0)
					{
						System.out.printf("%-7s %-7s %7d %7d %7d %7d %7d %7d %7d %7d %7s %7s %7s %7s %n", 
								custpro[s3][0],	custpro[s3][1], all[s3][0], month[s3][0], day[s3][0], year[s3][0], 
								all[s3][1], month[s3][1], day[s3][1], year[s3][1], 
								"null", "null", "null", "null");
					}else if(all[s3][0]==0 && all[s3][1]!=0 && all[s3][2]==0)
					{
						System.out.printf("%-7s %-7s %7s %7s %7s %7s %7d %7d %7d %7d %7s %7s %7s %7s %n", 
								custpro[s3][0],	custpro[s3][1], "null", "null", "null", "null", 
								all[s3][1], month[s3][1], day[s3][1], year[s3][1], 
								"null", "null", "null", "null");
					}else if(all[s3][0]==0 && all[s3][1]==0 && all[s3][2]!=0) 
					{
						System.out.printf("%-7s %-7s %7s %7s %7s %7s %7s %7s %7s %7s %7d %7d %7d %7d %n", 
								custpro[s3][0],	custpro[s3][1], "null", "null", "null", "null", 
								"null", "null", "null", "null", 
								all[s3][2], month[s3][2], day[s3][2], year[s3][2]);
					}
					...
					{
						System.out.printf("%-7s %-7d %7d %7d %7d %7s %7s %7s %7s %7s %7s %7s %7s %7s %n", 
								custpro[s3][0],	custpro[s3][1], all[s3][0], month[s3][0], day[s3][0], year[s3][0], 
								"null", "null", "null", "null", 
								"null", "null", "null", "null");
					}
